...
<body data-sidebar="dark">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="radio" name="contact_query"
                                                                        value="">Other
                                                                    <input type="text" name="contact_query_text"
                                                                        id="contact_query_text" />
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="maxi_working">Maxi.
                                                                        Working Temperature of the
                                                                        Slurry</label>
                                                                    <input type="text" name="maxi_working"><br>
                                                ...
                                                <div>
                                                    <form>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label>Nos. of Chambers require in a Filter
                                                                        Press</label>
                                                                    <input type="text" class="form-control"
    ...
    <div class="modal fade bs-example-modal-lg-presses" tabindex="-1" aria-labelledby="myLargeModalLabel"
                        ...
                        <div class="imagecollection">
                            <ul class="row">
                                @foreach ($presses as $presse)
                                    <div class="col-md-6">
                                        <li><input type="checkbox" id="presse{{ $presse->id }}" />
                                            <label for="presse{{ $presse->id }}"><img
                        ...
                        <div class="imagecollection1">
                            <ul class="row">
                                @foreach ($plates as $plate)
                                    <div class="col-md-6">
                                        <li>
                                            <input type="checkbox" id="plate{{ $plate->id }}" />
                                            <label for="plate{{ $plate->id }}"><img
